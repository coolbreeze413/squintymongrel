...
.PHONY: run-cmake
run-cmake:
	cmake -DCMAKE_INSTALL_PREFIX=$(PREFIX) -DCMAKE_BUILD_TYPE=Debug -DSQUINTYMONGREL_VERSION=$(VERSION) -DSQUINTYMONGREL_GIT_HASH=$(GIT_HASH) -S $(CMAKE_SOURCE_DIR) -B $(CMAKE_BUILD_DIR)
